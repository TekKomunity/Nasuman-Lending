...
class UserController extends Controller
{
    ...
    public function kycFormSubmitmob (Request $request)
    {
        
                    $userDetails        = [];
        
        // {"photo":{"type":"file","value":"2023\/01\/19\/63c877fb7609a1674082299.jpeg"},"full_name":{"type":"text","value":"Alfred"},"father's_name":{"type":"text","value":"George"},"mother's_name":{"type":"text","value":"Nelly"},"nid":{"type":"text","value":"9398271"}}
   
        
                $userDetails["full_name"]['type']    = "text";
                $userDetails["full_name"]['value']   = $request->full_name;
                
                                $userDetails["fathers_name"]['type']    = "text";
                $userDetails["fathers_name"]['value']   = $request->fathers_name;
                
                                $userDetails["mothers_name"]['type']    = "text";
                $userDetails["mothers_name"]['value']   = $request->mothers_name;
        



                        $userDetails["nid"]['type']    = "text";
                $userDetails["nid"]['value']   = $request->mothers_name;
            ...
            $path = imagePath()['verify']['user_kyc']['path'].'/'.$directory;
                    ...
                    try {
                        $userDetails["photo"]['value'] =  $directory.'/'.uploadImage($request->photo, $path);
                    } catch (\Exception $exp) {
