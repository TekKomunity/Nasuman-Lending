...
class LoginController extends Controller
{
    ...
    */
    ...
    public function login_mob(Request $request)
    {
 $email  = $request->mobile;
    $pass   = \Hash::make($request->password);
        ...
        if ($this->attemptLogin($request)) {
            return   response()->json(["data"=>auth()->user(),"status"=>"200","message"=>"Successfully Login"]);
        }


        return   response()->json(["data"=>"error","status"=>"404","message"=>"Credentials are Inalid"]);
    }
